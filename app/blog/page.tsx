...
export default async function BlogPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="pt-24 pb-20 bg-gradient-to-br from-slate-50 via-white to-emerald-50 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <div className="inline-block mb-6">
            <div className="bg-emerald-50 text-emerald-700 text-sm font-medium px-4 py-2 rounded-full border border-emerald-200">
